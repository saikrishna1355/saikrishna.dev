...
export default function Home() {
  return (
    <main>
      ...
      <section className="wrap timeline"><span className="section-tag">07 / EXPERIENCE</span><div className="timeline-grid"><div className="timeline-intro"><h2>Enterprise<br /><em>in practice.</em></h2><p>Four performance awards at Novac for building reliable software across insurance and fintech.</p></div><div className="timeline-list"><div><time>2025 — PRESENT</time><h3>Senior Software Engineer</h3><p>Novac Technology Solutions · React, Next.js, Node.js, AWS</p></div><div><time>2023 — 2025</time><h3>Software Engineer</h3><p>Novac · Travel Insurance Sales Platform &amp; Customer Portal / CRM</p></div><div><time>2022</time><h3>Programmer Analyst Trainee</h3><p>Cognizant · Enterprise application development</p></div></div></div></section>
